...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mb-4">
    <form action="{{ route('user.recipes.index') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
        <div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse whitespace-nowrap">
            ...
            <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="py-3 px-4">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('user.recipes.edit', $recipe) }}"
                ...
                @empty
                    <tr>
                        <td colspan="7" class="py-6 text-center text-slate-400">Tidak ada resep ditemukan.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
