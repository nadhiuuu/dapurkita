...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
    <form action="{{ $action }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            <label for ="content-editor" class="block text-sm font-semibold text-slate-700 mb-1">Isi Artikel</label>
            <textarea id="content-editor" name="content" rows="10" placeholder="Tuliskan konten artikel atau tips di sini..."
