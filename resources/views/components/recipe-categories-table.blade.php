        ...
        <table class="w-full text-left border-collapse whitespace-nowrap">
            ...
            <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="py-3 px-4 font-medium text-slate-800">Masakan Utama</td>
                    <td class="py-3 px-4 text-slate-500">masakan-utama</td>
                    <td class="py-3 px-4">
                        <span class="px-2.5 py-1 bg-slate-100 text-slate-700 text-xs font-semibold rounded-full">42 Resep</span>
                    </td>
                    <td class="py-3 px-4">
                        <div class="flex items-center justify-center gap-2">
                            <a href="/admin/recipe-categories/1/edit" class="p-1.5 text-slate-500 hover:text-orange-500 rounded hover:bg-orange-50 transition-colors">
                ...
                <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="py-3 px-4 font-medium text-slate-800">Minuman</td>
                    <td class="py-3 px-4 text-slate-500">minuman</td>
                    <td class="py-3 px-4">
                        <span class="px-2.5 py-1 bg-slate-100 text-slate-700 text-xs font-semibold rounded-full">18 Resep</span>
                    </td>
                    <td class="py-3 px-4">
                        <div class="flex items-center justify-center gap-2">
                            <a href="/admin/recipe-categories/2/edit" class="p-1.5 text-slate-500 hover:text-orange-500 rounded hover:bg-orange-50 transition-colors">
                                <i data-lucide="edit" class="w-4 h-4"></i>
                            </a>
                            <button class="p-1.5 text-slate-500 hover:text-red-500 rounded hover:bg-red-50 transition-colors">
                                <i data-lucide="trash-2" class="w-4 h-4"></i>
