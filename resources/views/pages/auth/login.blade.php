...
<main class="min-h-screen pt-28 pb-16 bg-slate-50 flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-8">
        <div class="text-center mb-6">
            <a href="/" class="inline-flex items-center gap-2.5 font-bold text-orange-500 mb-3 hover:opacity-90 transition-opacity">
            ...
            <p class="text-sm text-slate-500 mt-1">Masuk ke akun DapurKita Anda</p>
        </div>
        <x-login-form />
    </div>
</main>
