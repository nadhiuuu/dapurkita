...
<div class="mb-3 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
    <div>
        <h1 class="text-2xl font-bold text-slate-800">Tips & Artikel</h1>
        <p class="text-sm text-slate-500">Kelola artikel edukasi, tips memasak, dan status tayang</p>
    </div>
    <a href="{{ route('admin.tips-articles.create') }}"
...
<x-tips-articles-admin-table :tipsArticles="$tipsArticles" :categories="$categories" />
